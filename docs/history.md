...
结果：发布候选的 99/99 项测试与生产构建通过；脚本为 365,441 字节，gzip 77,797 字节。
常规 E-Hentai、18comic、4KHD 与既有移动端真实交互验收通过，动图库在 Chrome 基线、
EhSyringe 共存和移动视口压力回归通过；发布等待 Firefox 与最新候选的真实触控最终确认。
